...
class VacanciesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'employer_key' => ['type' => 'index', 'columns' => ['employer_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'vacancies_ibfk_1' => ['type' => 'foreign', 'columns' => ['employer_id'], 'references' => ['employers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-11-08 16:18:46',
                'modified' => '2019-11-08 16:18:46'
            ],
        ];
        parent::init();
    }
